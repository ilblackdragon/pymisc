...
tag_check = re.compile(r'^(a|blockquote|p|u|b|i|em|strike|strong|ul|ol|li|sub|sup|br|hr|object|param|embed|h1|h2|h3|h4|h5|h6|address|pre|iframe|img|span|table|tr|td|tname|tbody|div|dd|dt)$', re.IGNORECASE)
attr_check = {}
attr_value_check = {}
style_check = {}
style_value_check = {}
...
attr_value_check['a']['href'] = re.compile(r'^(https?://.*)$', re.IGNORECASE)
...
attr_check['span'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
...
attr_check['table'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
...
attr_check['tr'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
attr_value_check['tr'] = {}
...
attr_check['td'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
attr_value_check['td'] = {}
...
attr_check['tname'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
...
attr_check['tbody'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
...
attr_check['div'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
...
attr_check['dd'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
attr_value_check['dd'] = {}
...
attr_check['dt'] = re.compile(r'^(width|height|style)$', re.IGNORECASE)
attr_value_check['dt'] = {}
